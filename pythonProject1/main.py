...
#
# imggray=cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
# imgblur=cv2.GaussianBlur(imggray,(9,9),15)
...
#     cv2.putText(frame, "Urvashi Kushwaha", (100, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
#     cv2.imshow("Video",frame)
#     #cv2.putText(frame, "Urvashi Kushwaha", (200, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
#     if cv2.waitKey(1)==ord("q"):
#         break
#
# cap.release()
